...
public class GramaticaController {
    ...
    private ListView<String> ListNoTerminales; // Value injected by FXMLLoader
    ...
    @FXML // fx:id="btnGenerarChomsky"
    private Button btnGenerarChomsky; // Value injected by FXMLLoader

    @FXML // fx:id="btnGenerarPalabrasFNC"
    private Button btnGenerarPalabrasFNC; // Value injected by FXMLLoader
    
    @FXML // fx:id="btnLimpiarFNC"
    private Button btnLimpiarFNC; // Value injected by FXMLLoader
    
    @FXML // fx:id="cboGramaticaFNC"
    private ComboBox<Gramatica> cboGramaticaFNC; // Value injected by FXMLLoader
    
    @FXML // fx:id="cboProduccionesFNC"
    private ComboBox<String> cboProduccionesFNC; // Value injected by FXMLLoader
    
    @FXML // fx:id="tabFNC"
    private Tab tabFNC; // Value injected by FXMLLoader

    @FXML // fx:id="tabGramatica"
    private Tab tabGramatica; // Value injected by FXMLLoader

    @FXML // fx:id="txtNumeroPalabrasFNC"
    private TextField txtNumeroPalabrasFNC; // Value injected by FXMLLoader

    @FXML // fx:id="txtSimboloTerminal"
    private TextField txtSimboloTerminal; // Value injected by FXMLLoader

    @FXML // fx:id="txtSimboloVariable"
    private TextField txtSimboloVariable; // Value injected by FXMLLoader
    
    @FXML // fx:id="tabInterfaz"
    private TabPane tabInterfaz; // Value injected by FXMLLoader
    ...
    private ObservableList<String> variablesNoTerminales = FXCollections.observableArrayList();
    ...
    void agregarGramatica(ActionEvent event) {
        ...
        try
        {
            ...
            actualizarCBOGramaticas(this.cboGramaticaFNC, 1);
    ...
    void agregarNoTerminal(ActionEvent event) {
        ...
        try
        {
            ...
            actualizarTablas(this.cboGramatica.getValue(),0);
    ...
    void eliminarNoTerminal(ActionEvent event) {
        ...
        try
        {
            ...
            char noTerminal = this.ListNoTerminales.getSelectionModel().selectedItemProperty().getValue().charAt(0);
            ...
            this.actualizarTablas(this.cboGramatica.getValue(),0); 
            actualizarCBOGramaticas(this.cboInicial, 2);
    ...
    void modificarNoTerminl(ActionEvent event) {
        ...
        try
        {
            ...
            char terminal = this.ListNoTerminales.getSelectionModel().selectedItemProperty().getValue().charAt(0);
   ...
   private void actualizarTablas(Gramatica gramatica, int tipo)
   {
       ...
       if(!terminales.isEmpty())
       {
            ...
            this.variablesTerminales.remove(0);
       ...
       }else
       {
           ...
           ListaCD<String> noTerminales = gramatica.getFNC().getVariablesNoTerminales();
            ...
            if(!noTerminales.isEmpty())
            {
                ...
                for(String s:noTerminales)
                {
                    ...
                    this.variablesNoTerminales.add(s);
            ...
            cambiarProduccionFNC(gramatica);
    ...
    private void cambiarProduccionFNC(Gramatica gramatica)
    {
    
        this.producciones.clear();
        ListaCD<String> cadenaProducciones = gramatica.getFNC().getProducciones().get(this.cboProduccionesFNC.getValue());
    ...
    void cambioTabFNC(Event event) {
        ...
        try
        {
            ...
            if(gramatica != null)
            {
                ...
                if (!this.cboProduccionesFNC.getItems().isEmpty()) {
                    this.cboProduccionesFNC.getSelectionModel().selectFirst();
                }else
                {

                    this.cboProduccionesFNC.setValue(null);
            ...
            this.btnModificarTerminal.setDisable(true);
            this.txtModificarTerminal.setDisable(true);
            this.btnEliminarTerminal.setDisable(true);
            
            this.btnModificarNoTerminal.setDisable(true);
            this.txtModificarNoTerminal.setDisable(true);
            this.btnEliminarNoTerminal.setDisable(true);
           
            this.btnModificarProduccion.setDisable(true);
            this.txtModificarProduccion.setDisable(true);
            this.btnEliminarProduccion.setDisable(true);
    ...
    @FXML
    void cambioTabGramatica(Event event) {
        ...
        try
        {
            ...
            this.btnModificarTerminal.setDisable(false);
            this.txtModificarTerminal.setDisable(false);
            this.btnEliminarTerminal.setDisable(false);
            
            this.btnModificarNoTerminal.setDisable(false);
            this.txtModificarNoTerminal.setDisable(false);
            this.btnEliminarNoTerminal.setDisable(false);
           
            this.btnModificarProduccion.setDisable(false);
            this.txtModificarProduccion.setDisable(false);
            this.btnEliminarProduccion.setDisable(false);            
    ...
    @FXML
    void generarChosmky(ActionEvent event) {

        try
        {
        
            if(this.cboGramaticaFNC.getValue() == null)
            {
            ...
            Gramatica gramatica = cboGramaticaFNC.getValue();
            
            if(this.txtSimboloTerminal.getText().isEmpty() || this.txtSimboloTerminal.getText().isBlank())
            {
            
                throw new RuntimeException("No hay ningun simbolo ingresado, por favor ingresa un valor en el campo.");
            
            }
            
            if(this.txtSimboloVariable.getText().isEmpty() || this.txtSimboloVariable.getText().isBlank())
            {
    ...
    @FXML
    void generarPalabrasChomsky(ActionEvent event) {
        ...
        try
        {
            ...
            if(this.txtNumeroPalabrasFNC.getText().isEmpty() || this.txtNumeroPalabrasFNC.getText().isBlank())
            {
            
                throw new RuntimeException("Ingresa un numero de palabras valido para la opercion.");
            
            }
            
            Set<String> palabras = gramaticas.generarPalabrasFNC(this.cboGramatica.getValue(), Integer.parseInt(this.txtNumeroPalabrasFNC.getText()));
            
            this.txtPalabras.appendText("\n Palabras del Lenguaje en FNC: \n");
            this.txtPalabras.appendText("\n");
    ...
    @FXML
    void seleccionarProduccionesFNC(ActionEvent event) {

        if(this.cboGramaticaFNC.getValue() != null)
        {
        
            cambiarProduccionFNC(this.cboGramaticaFNC.getValue());
    ...
    void initialize() {
        ...
        assert btnGenerarChomsky != null : "fx:id=\"btnGenerarChomsky\" was not injected: check your FXML file 'ViewGramatica.fxml'.";
        assert btnGenerarPalabrasFNC != null : "fx:id=\"btnGenerarPalabrasFNC\" was not injected: check your FXML file 'ViewGramatica.fxml'.";
        assert btnLimpiarFNC != null : "fx:id=\"btnLimpiarFNC\" was not injected: check your FXML file 'ViewGramatica.fxml'.";
        assert cboGramaticaFNC != null : "fx:id=\"cboGramaticaFNC\" was not injected: check your FXML file 'ViewGramatica.fxml'.";
        assert cboProduccionesFNC != null : "fx:id=\"cboProduccionesFNC\" was not injected: check your FXML file 'ViewGramatica.fxml'.";
        assert tabFNC != null : "fx:id=\"tabFNC\" was not injected: check your FXML file 'ViewGramatica.fxml'.";       
        assert tabGramatica != null : "fx:id=\"tabGramatica\" was not injected: check your FXML file 'ViewGramatica.fxml'.";
        assert txtNumeroPalabrasFNC != null : "fx:id=\"txtNumeroPalabrasFNC\" was not injected: check your FXML file 'ViewGramatica.fxml'.";
        assert txtSimboloTerminal != null : "fx:id=\"txtSimboloTerminal\" was not injected: check your FXML file 'ViewGramatica.fxml'.";
        assert txtSimboloVariable != null : "fx:id=\"txtSimboloVariable\" was not injected: check your FXML file 'ViewGramatica.fxml'.";
        assert tabInterfaz != null : "fx:id=\"tabInterfaz\" was not injected: check your FXML file 'ViewGramatica.fxml'.";
